...
package dev.mohamadsaleh82.plus.connectivity;
...
public class ConnectivityPlugin implements FlutterPlugin {
  ...
  private void setupChannels(BinaryMessenger messenger, Context context) {
    methodChannel = new MethodChannel(messenger, "dev.mohamadsaleh82.plus/connectivity");
    eventChannel = new EventChannel(messenger, "dev.mohamadsaleh82.plus/connectivity_status");
