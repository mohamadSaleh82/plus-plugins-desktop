...
void main() {
  ...
  test('accelerometerEvents are streamed', () async {
    const channelName = 'dev.mohamadsaleh82.plus/sensors/accelerometer';
  ...
  test('gyroscopeEvents are streamed', () async {
    const channelName = 'dev.mohamadsaleh82.plus/sensors/gyroscope';
    final date = DateTime.now();
    final sensorData = <double>[
      3.0,
      4.0,
  ...
  test('userAccelerometerEvents are streamed', () async {
    const channelName = 'dev.mohamadsaleh82.plus/sensors/user_accel';
    final date = DateTime.now();
    final sensorData = <double>[
      6.0,
      7.0,
  ...
  test('magnetometerEvents are streamed', () async {
    const channelName = 'dev.mohamadsaleh82.plus/sensors/magnetometer';
    final date = DateTime.now();
    final sensorData = <double>[
      8.0,
      9.0,
  ...
  test('barometerEvents are streamed', () async {
    const channelName = 'dev.mohamadsaleh82.plus/sensors/barometer';
    final date = DateTime.now();
    final sensorData = <double>[
      1000.0,
      date.microsecondsSinceEpoch.toDouble(),
...
void _initializeFakeMethodChannel(String methodName) {
  ...
  TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
      .setMockMessageHandler('dev.mohamadsaleh82.plus/sensors/method',
