...
class MethodChannelSensors extends SensorsPlatform {
  static const MethodChannel _methodChannel =
      MethodChannel('dev.mohamadsaleh82.plus/sensors/method');

  static const EventChannel _accelerometerEventChannel =
      EventChannel('dev.mohamadsaleh82.plus/sensors/accelerometer');

  static const EventChannel _userAccelerometerEventChannel =
      EventChannel('dev.mohamadsaleh82.plus/sensors/user_accel');

  static const EventChannel _gyroscopeEventChannel =
      EventChannel('dev.mohamadsaleh82.plus/sensors/gyroscope');

  static const EventChannel _magnetometerEventChannel =
      EventChannel('dev.mohamadsaleh82.plus/sensors/magnetometer');

  static const EventChannel _barometerEventChannel =
      EventChannel('dev.mohamadsaleh82.plus/sensors/barometer');
