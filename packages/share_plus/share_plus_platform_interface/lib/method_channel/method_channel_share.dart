...
class MethodChannelShare extends SharePlatform {
  ...
  static const MethodChannel channel =
      MethodChannel('dev.mohamadsaleh82.plus/share');
  ...
  Future<ShareResult> shareUri(
    ...
    final result = await channel.invokeMethod<String>('shareUri', params) ??
        'dev.mohamadsaleh82.plus/share/unavailable';
  ...
  Future<XFile> _getFile(
    ...
    if (file.path.isNotEmpty) {
      ...
      //Per Issue [#3032](https://github.com/mohamadsaleh82/plus_plugins/issues/3032): use overridden name when available.
      //Per Issue [#1548](https://github.com/mohamadsaleh82/plus_plugins/issues/1548): attempt to use XFile.name when available
  ...
  static ShareResultStatus _statusFromResult(String result) {
    switch (result) {
      ...
      case 'dev.mohamadsaleh82.plus/share/unavailable':
