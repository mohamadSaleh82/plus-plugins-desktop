## 10.0.2
 ...
 - **FIX**(share_plus): [#2910](https://github.com/mohamadsaleh82/plus_plugins/issues/2910) Handle user dismissing dialog on shareUri() in web ([#3175](https://github.com/mohamadsaleh82/plus_plugins/issues/3175)). ([bba78118](https://github.com/mohamadsaleh82/plus_plugins/commit/bba781187b4af5682331ed90929c61c13137809a))

## 10.0.1

- **CHORE**(share_plus): Update to package:web to ^1.0.0 ([#3105](https://github.com/mohamadsaleh82/plus_plugins/pull/3105)). ([1f23910a](https://github.com/mohamadsaleh82/plus_plugins/commit/1f23910ab50fef2e499054f35cedfd14c578976a))
...
> Note: This release has breaking changes.
 ...
 - **DOCS**(share_plus): Update README.md ([#2903](https://github.com/mohamadsaleh82/plus_plugins/issues/2903)). ([2a547eb3](https://github.com/mohamadsaleh82/plus_plugins/commit/2a547eb3f0093160279fbc9de21dde3f3ff75c81))
...
## 8.0.3
 ...
 - **REFACTOR**(share_plus): Migrate Android example to use the new plugins declaration ([#2742](https://github.com/mohamadsaleh82/plus_plugins/issues/2742)). ([a73af898](https://github.com/mohamadsaleh82/plus_plugins/commit/a73af898ee9b73dcc53307186ac4c79e795b1277))
 - **FIX**(share_plus): Recover ShareSuccessManager state after error ([#2817](https://github.com/mohamadsaleh82/plus_plugins/issues/2817)). ([2b12d8a8](https://github.com/mohamadsaleh82/plus_plugins/commit/2b12d8a8ada0d3f00abda0467946bb241361d016))
 - **DOCS**(share_plus): Add info regarding localization on Apple to README ([#2764](https://github.com/mohamadsaleh82/plus_plugins/issues/2764)). ([43f9a305](https://github.com/mohamadsaleh82/plus_plugins/commit/43f9a3051652448868c5031a45276f9ff870a025))
 - **DOCS**(share_plus): remove typo from the changelog ([#2747](https://github.com/mohamadsaleh82/plus_plugins/issues/2747)). ([961c8e2d](https://github.com/mohamadsaleh82/plus_plugins/commit/961c8e2dbf2210947cbed898c90e2776322a0942))
...
- **BREAKING** **FEAT**(share_plus): Migrate to package:web ([#2709](https://github.com/mohamadsaleh82/plus_plugins/issues/2709)). ([641e7905](https://github.com/mohamadsaleh82/plus_plugins/commit/641e7905b4055827f1481f036415095dc43afe5f))
- **BREAKING** **BUILD**(share_plus): Target Java 17 on Android ([#2730](https://github.com/mohamadsaleh82/plus_plugins/issues/2730)). ([e6853a06](https://github.com/mohamadsaleh82/plus_plugins/commit/e6853a06fa110d69776a85684e302a7c900a6e07))
- **BREAKING** **BUILD**(sensors_plus): Update to target and compile SDK 34 ([#2712](https://github.com/mohamadsaleh82/plus_plugins/pull/2712)). ([b752fc3](https://github.com/mohamadsaleh82/plus_plugins/commit/b752fc3bac2b7ce614faf0fbed010200d99a717b))
- **FIX**(share_plus): Resolve deprecation warning in Android part ([#2717](https://github.com/mohamadsaleh82/plus_plugins/issues/2717)). ([5913ac72](https://github.com/mohamadsaleh82/plus_plugins/commit/5913ac72f6dfcb0f02c371907871805c940a03a8))
...
- **FIX**(share_plus): Add missing call to result for shareUri on iOS ([#2616](https://github.com/mohamadsaleh82/plus_plugins/issues/2616)). ([65f23a5d](https://github.com/mohamadsaleh82/plus_plugins/commit/65f23a5d12ac988d7424a56b1d808f2983e0459f))
- **FIX**(share_plus): Add iOS Privacy Info ([#2586](https://github.com/mohamadsaleh82/plus_plugins/issues/2586)). ([17fc2e05](https://github.com/mohamadsaleh82/plus_plugins/commit/17fc2e058f04168f17f5118bca24b02483af571b))
- **FIX**(share_plus): Ensure subject is not null before calling putExtra(Intent.EXTRA_SUBJECT, subject) ([#2518](https://github.com/mohamadsaleh82/plus_plugins/issues/2518)). ([f0bbbefc](https://github.com/mohamadsaleh82/plus_plugins/commit/f0bbbefc712e01da20e8107e8d25b2005cf7b728))
- **FEAT**(share_plus): Update min iOS target to 12 ([#2662](https://github.com/mohamadsaleh82/plus_plugins/issues/2662)). ([5cef2e50](https://github.com/mohamadsaleh82/plus_plugins/commit/5cef2e500cd10d55b749a6d53ce6e733fdb54d34))
- **DOCS**(share_plus): Fix supported platforms in README ([#2510](https://github.com/mohamadsaleh82/plus_plugins/issues/2510)). ([6b4b855b](https://github.com/mohamadsaleh82/plus_plugins/commit/6b4b855bb6f3c2897e29d0d3ae4a0c0c99ff8c2f))
...
> Info: This release is a replacement for release 8.0.0, which was retracted due to issue ([#2251](https://github.com/mohamadsaleh82/plus_plugins/issues/2251)). As breaking change was reverted the major release was also reverted in favor of this one.

 - **FIX**(share_plus): Change Kotlin version from 1.9.10 to 1.7.22 ([#2252](https://github.com/mohamadsaleh82/plus_plugins/issues/2252)). ([d4954f36](https://github.com/mohamadsaleh82/plus_plugins/commit/d4954f36b633e5894cfb4aff4acc995348ce3dca))
 - **FIX**(share_plus): Revert bump to compileSDK 34 ([#2234](https://github.com/mohamadsaleh82/plus_plugins/issues/2234)). ([6af2328d](https://github.com/mohamadsaleh82/plus_plugins/commit/6af2328da997b452758e6c78f3815bcf55ac24aa))
 - **FEAT**(share_plus): Remove deprecated VALID_ARCHS iOS property ([#2024](https://github.com/mohamadsaleh82/plus_plugins/issues/2024)). ([bb79888e](https://github.com/mohamadsaleh82/plus_plugins/commit/bb79888eda6425d8e772bb4bea47f4966610240f))
 - **DOCS**(share_plus): Fix usage code snippets ([#2106](https://github.com/mohamadsaleh82/plus_plugins/issues/2106)). ([346e07ea](https://github.com/mohamadsaleh82/plus_plugins/commit/346e07ea56088321f92530e4334edab0400f4c43))

## 7.1.0

 - **FIX**(share_plus): Regenerate iOS and MacOS example apps ([#1869](https://github.com/mohamadsaleh82/plus_plugins/issues/1869)). ([5db20ba7](https://github.com/mohamadsaleh82/plus_plugins/commit/5db20ba7aebd7787a7e56df8e8e6bcb6f832f230))
 ...
 - **DOCS**(share_plus): Updated document with latest available method ([#1917](https://github.com/mohamadsaleh82/plus_plugins/issues/1917)). ([7fbe3de6](https://github.com/mohamadsaleh82/plus_plugins/commit/7fbe3de61b874b7d83d66f70c1e2928378707f86))
...
- **CHORE**(share_plus): Update file dependency constraints ([#1853](https://github.com/mohamadsaleh82/plus_plugins/pull/1853)). ([d8ff0cdb](https://github.com/mohamadsaleh82/plus_plugins/commit/d8ff0cdb665048c59c8acc5fecd1a9c099ee012f))
...
## 7.0.1
 ...
 - **CHORE**(share_plus): Win32 dependency upgrade ([#1805](https://github.com/mohamadsaleh82/plus_plugins/pull/1805)). ([3f68800](https://github.com/mohamadsaleh82/plus_plugins/commit/c8f7b6342a7c51eafafae95792775505d2b52ce9))
