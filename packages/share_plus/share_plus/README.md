...
[![share_plus](https://github.com/mohamadsaleh82/plus_plugins/actions/workflows/share_plus.yaml/badge.svg)](https://github.com/mohamadsaleh82/plus_plugins/actions/workflows/share_plus.yaml)
...
To use this plugin, add `share_plus` as a [dependency in your pubspec.yaml file](https://plus.mohamadsaleh82.dev/docs/overview).
...
or search for other Flutter plugins implementing this SDK. More information can be found in [this issue](https://github.com/mohamadsaleh82/plus_plugins/issues/413).
...
It could happen that the Share sheet appears with a different language, [as reported here](https://github.com/mohamadsaleh82/plus_plugins/issues/2696).
