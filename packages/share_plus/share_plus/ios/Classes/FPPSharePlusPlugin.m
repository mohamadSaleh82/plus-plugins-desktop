...
static NSString *const PLATFORM_CHANNEL = @"dev.mohamadsaleh82.plus/share";
...
- (id)activityViewControllerPlaceholderItem:
  ...
  return [self
      activityViewController:activityViewController
         itemForActivityType:@"dev.mohamadsaleh82.share_plus.placeholder"];
}
...
- (id)activityViewController:(UIActivityViewController *)activityViewController
  ...
  // to show a preview.
  if ([activityType
          isEqualToString:@"dev.mohamadsaleh82.share_plus.placeholder"] &&
