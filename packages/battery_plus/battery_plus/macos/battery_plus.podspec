...
A Flutter plugin for accessing information about the battery state(full, charging, discharging).
                       DESC
  s.homepage         = 'https://github.com/mohamadsaleh82/plus_plugins/tree/main/packages/battery_plus'
  s.license          = { :file => '../LICENSE' }
  s.author           = { 'Flutter Community' => 'authors@mohamadsaleh82.dev' }
  s.source           = { :path => 'https://github.com/mohamadsaleh82/plus_plugins/tree/main/packages/battery_plus' }
