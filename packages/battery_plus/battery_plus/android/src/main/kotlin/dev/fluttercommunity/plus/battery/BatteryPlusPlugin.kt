package dev.mohamadsaleh82.plus.battery
...
class BatteryPlusPlugin : MethodCallHandler, EventChannel.StreamHandler, FlutterPlugin {
    ...
    override fun onAttachedToEngine(binding: FlutterPluginBinding) {
        ...
        methodChannel = MethodChannel(binding.binaryMessenger, "dev.mohamadsaleh82.plus/battery")
        eventChannel = EventChannel(binding.binaryMessenger, "dev.mohamadsaleh82.plus/charging")
