...
- Fork `https://github.com/mohamadsaleh82/plus_plugins` into your own GitHub account. If
...
- `git remote add upstream git@github.com:mohamadsaleh82/plus_plugins.git` (So that you
...
A full list of all commands can be found within the [`melos.yaml`](https://github.com/mohamadsaleh82/plus_plugins/blob/main/melos.yaml)
file.
...
- `git pull-request` (if you are using [Hub](http://github.com/github/hub/)) or
  go to `https://github.com/mohamadsaleh82/plus_plugins` and click the
